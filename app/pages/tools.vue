...
<template>
  <!-- Section wrapper: pure black -->
  <div class="bg-neutral-950 py-16">
    <header class="text-center mb-6">
      <h1 class="text-3xl md:text-4xl font-bold text-white">/tools</h1>
    </header>
    <section class="max-w-6xl mx-auto px-6 md:px-8 text-white">
      <header class="mb-6">
        <h2 class="text-3xl md:text-4xl font-bold text-neutral-200 dark:text-white">Technologies & Tools</h2>
      </header>
      ...
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <!-- Card: lighter grey than background -->
          <Card
              class="group rounded-2xl border border-neutral-800
          ...
          >
            ...
            <CardContent
                class="flex flex-wrap gap-2 transition-transform duration-300 group-hover:scale-[1.01] flex-grow"
            >
              <!-- Badges: slightly lighter again -->
              <Badge
                  ...
                  class="gap-2 px-3 py-1 rounded-md border
                       ...
                       transition-colors duration-200 hover:bg-neutral-700/80"
              >
